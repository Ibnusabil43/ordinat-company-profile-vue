  ...
  <section id="visi_misi" class="py-12 sm:py-16 lg:py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid lg:grid-cols-2 gap-6 lg:gap-8">
        <!-- Vision Card -->
        <div class="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-8 lg:p-10 text-white shadow-xl">
        ...
        <!-- Mission Card -->
        <div class="bg-white rounded-2xl p-8 lg:p-10 shadow-xl border border-gray-100">
          <div class="flex items-center gap-4 mb-6">
